...
class WP_Push_Syndication_Server {
	...
	public function __construct() {
		...
		// Note: save_post, delete_post, create_term, delete_term for site/sitegroup changes
		// and syn_refresh_pull_jobs are now handled by PluginBootstrapper using the new service layer.
	...
	// Note: schedule_push_content and push_content are now handled by
	// PluginBootstrapper using the new service layer.
	...
	// Note: pull_get_selected_sites, sort_sites_by_last_pull_date, pull_content,
	// syndication_user_agent, find_post_by_guid, refresh_pull_jobs, handle_site_change,
	// handle_site_group_change, and schedule_deferred_pull_jobs_refresh are now handled
	// by PluginBootstrapper using the new service layer.
